...
PAGES = {
    ...
    "blog.html": {
        "body_class": "accent-purple",
        "title": "The Quoti Journal — Business Strategy, Finance & Operations Blog | Quoti Consulting",
        "desc": "The Quoti Journal: insights, strategies, and practical tools to help businesses build strong foundations, improve operations, and achieve sustainable growth.",
        "keywords": "small business blog, business strategy articles, accounting tips blog, business credit articles, funding advice, compliance blog, The Quoti Journal",
        "active": "BLOG",
        "jsonld": [ORG, {
            "@type": "Blog",
            "name": "The Quoti Journal",
            "url": BASE + "/blog.html",
            "publisher": {"@id": BASE + "/#organization"},
            "description": "Insights, strategies, and practical tools to help businesses build strong foundations, improve operations, and achieve sustainable growth.",
        }, breadcrumbs(("Home", "index.html"), ("Blog", "blog.html"))],
    },
    "podcast.html": {
        "body_class": "accent-purple",
        "title": "The Quoti Advantage Podcast — Smart Strategies. Strong Foundations. Sustainable Growth. | Quoti Consulting",
        "desc": "The Quoti Advantage Podcast: smart strategies, strong foundations, and sustainable growth. Weekly conversations on business foundations, financial leadership, business systems, funding, SOPs, leadership and entrepreneur success stories.",
        "keywords": "business podcast, The Quoti Advantage Podcast, small business strategy podcast, IRS insights podcast, small business finance podcast, entrepreneur success stories",
        "active": "PODCAST",
        "jsonld": [ORG, {
            "@type": "PodcastSeries",
            "name": "The Quoti Advantage Podcast",
            "url": BASE + "/podcast.html",
            "description": "Smart Strategies. Strong Foundations. Sustainable Growth. Weekly conversations about business foundations, financial leadership, business systems, funding, SOPs, leadership and entrepreneur success stories.",
            "publisher": {"@id": BASE + "/#organization"},
