...
- **Dual accent palette** — signature gold plus the client's sapphire blue (`--blue`, `.blue`, `.btn-blue`), woven through stats, icons, focus states, nav underlines and the Quoti Live sub-brand in both themes
