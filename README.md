...
**Created By: [Quoti Consulting Inc.](https://quoticonsulting.com)**
...
The production domain is set to `https://quoticonsulting.com` in `_build/build.py` (`BASE`), `sitemap.xml`, `robots.txt` and `llms.txt` — change it there if the site ever moves.
...
© Quoti Consulting. Site design & build — **Created By: [Quoti Consulting Inc.](https://quoticonsulting.com)**# Quoti Consulting — Website
